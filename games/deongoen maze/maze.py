...
wn.addshape(r"c:\Users\joe\OneDrive\Pictures\Zgta.gif")
wn.addshape(r"c:\Users\joe\OneDrive\Pictures\treasure.gif")
wn.addshape(r"c:\Users\joe\OneDrive\Pictures\wall.gif")
wn.addshape(r"c:\Users\joe\OneDrive\Pictures\212.gif")
...
class Player(turtle.Turtle):
    def __init__(self):
        ...
        self.shape(r"c:\Users\joe\OneDrive\Pictures\Zgta.gif")
...
class Tresure(turtle.Turtle):
    def __init__(self, x, y):
        turtle.Turtle.__init__(self)
        self.shape(r"c:\Users\joe\OneDrive\Pictures\treasure.gif")
        self.color("yellow")
        self.penup()
        self.speed(0)
        self.gold = 100
...
class Enemy(turtle.Turtle):
    def __init__(self, x, y):
        turtle.Turtle.__init__(self)
        self.shape(r"c:\Users\joe\OneDrive\Pictures\212.gif")
        self.color("red")
        self.penup()
        self.speed(0)
        self.gold = 25
    ...
    for y in range (len(level)):
        for x in range (len(level[y])):
            ...
            if charecter == "B":
                ...
                pen.shape(r"c:\Users\joe\OneDrive\Pictures\wall.gif")
                pen.stamp()
